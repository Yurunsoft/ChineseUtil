...
$php_url="https://windows.php.net/downloads/releases/archives/php-7.4.10-nts-Win32-vc15-x86.zip"

$php_dev_url="https://windows.php.net/downloads/releases/archives/php-devel-pack-7.4.10-nts-Win32-vc15-x86.zip"
